...
public class BookingController {
     ...
     @PostMapping("/book")
     public ResponseEntity<Response> book(@RequestBody @Validated BookingRequest bookingRequest) {
         return ok(bookingService.book(bookingRequest));
     }

     @PostMapping("/cancel")
        public ResponseEntity<Response> cancel(@RequestBody @Validated BookingCancelRequest cancelRequest) {
